...
_, movie_movie_recommender = dump.load(settings.STORAGES_ROOT / "recommender/movie_movie_recommender")
_, user_movie_recommender = dump.load(settings.STORAGES_ROOT / "recommender/user_movie_recommender")
