...
class Users(Model):
    ...
    profile_image_id = fields.ForeignKeyField(
        model_name="models.ProfileImages", null=True
    )
    description = fields.CharField(max_length=140, null=True)
    role = fields.CharField(
        max_length=16, default="user"
    )  # may need changing, i.e. Do we want an enum field?
    ...
    # Relational fields
    ratings: fields.ManyToManyRelation["Ratings"]
